// work_weather_addon.js — injects weather next to "Under arbeid" title
(function(){
  const $ = s=>document.querySelector(s);

  function strokeColor(){
    // choose a visible stroke; if your theme is light, dark stroke is visible
    return '#111827';
  }
  ...
  async function loadWeather(){
    ...
    try{
      ...
      const ic = $('#wx_icon'), tp = $('#wx_temp'), ds = $('#wx_desc');
