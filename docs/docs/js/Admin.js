// js/Admin.js (config + adresse-register)
(function(){
  'use strict';
  ...
  function adminLoad(){
    const cfg = getCfg(); const st = settings();
  ...
  function adminSave(){
    ...
    setCfg({ binId: driftBin, apiKey: masterKey }); const st = settings(); st.reportBin = reportBin; WJ(LS_SETTINGS, st);
    alert('Lagret ✅');
  }
  ...
  document.addEventListener('DOMContentLoaded', ()=>{
    adminLoad();
    document.getElementById('admin_save_bins')?.addEventListener('click', adminSave);
